...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/external \
	...
	$(LOCAL_PATH)/librose \
	$(LOCAL_PATH)/kdesktop \
	$(LOCAL_PATH)/external/freerdp/channels/client \
...
LOCAL_SRC_FILES := \
	$(subst $(LOCAL_PATH)/,, \
	$(wildcard $(LOCAL_PATH)/kdesktop/*.c) \
	$(wildcard $(LOCAL_PATH)/kdesktop/*.cc) \
	$(wildcard $(LOCAL_PATH)/kdesktop/*.cpp) \
	$(wildcard $(LOCAL_PATH)/kdesktop/gui/dialogs/*.c) \
	$(wildcard $(LOCAL_PATH)/kdesktop/gui/dialogs/*.cpp) \
...
include $(LOCAL_PATH)/external/freerdp/Android-client.mk
